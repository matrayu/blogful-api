//using date strings because endpoint can't respond with JavaScript object
//The endpoints we want to test will return JSON, so we store string versions 
//of the dates instead of new Date(datastring)
